...
<div class='col-sm-4'>
 ...
 <div class='col-sm-4'>
        ...
        <thead>
          ...
          <tr>
              ...
              <th  colspan="2" style="background-color: #F5F5F6"> <a  href="home.php?item=56" style="text-decoration: none"> <h3 style="text-align: center; padding: 0px; margin: 0px"><img src="images/book2.png" width="50"/>&nbsp;<span class="boxshadow"  style="padding: 5px">  Total Subject
        =<?php 
 ...
 <div class='col-sm-4'>
        ...
        <th  colspan="2" style="background-color: #F5F5F6"> <a  href="home.php?item=86" style="text-decoration: none"> <h3 style="text-align: center; padding: 0px; margin: 0px"><img src="images/dor.png" width="50"" />&nbsp;<span class="boxshadow"  style="padding: 5px">  Total Dormitories
        =<?php 
