...
<div style='margin:10px' class='boxshadow'>
   ...
   if(isset($_POST['btnSearch'])){?>
	...
	<div class="btn-group">
     ...
     <form action='home.php?item=90' method='post'>
                <input type='hidden' value='<?php echo $id?>' name='txtDriverId'/>&nbsp;&nbsp;
     ...
     <form action='home.php?item=89' method='post' onSubmit="return confirm('Are you sure Delete this record?');" >
                <input type='hidden' value='<?php echo $id?>' name='txtDriverId'/>&nbsp;&nbsp;
               <span class="boxshadow">  
...
?>
  ...
  <span class=' boxshadow ' style='float:right; padding: 3px'><a href='home.php?item=88'  style='font-weight:bold; color:#5A5A5A; text-decoration:none; margin:3px'>   <i class='glyphicon glyphicon-plus-sign'></i>  Add Driver</a></span></td></tr>
     <tr><th   >ID</th><th >Name</th><th >Photo</th><th>E-mail</th><th>Phone</th><th>Gender</th><th>Jion Date</th><th>Options</th></tr></thead>
  <?php
