...
<h2 class='styl boxshadow'><span class='style boxshadow'> Add Driver   </span></h2>
<?php
...
if(isset($_POST["btnSubmit"])){
	...
	$errors=array();
	 ...
	 if($dname==""){		 
	   array_push($errors,"Driver name field is empty!");	 
	 }	
	...
	if(count($errors)==0){
		$db->query("insert into say_driver(name,photo,email,gender,phone,join_date)values('$dname','$upload_image','$mail ','$gender','$mobile','$join');");
		 echo "<div class='alert alert-success' role='alert'><strong>Successfully Created!</strong></div>";
		$dname = $photo = $mail = $gender =  $mobile = $join ="";
	}else{
...
<form action="home.php?item=88" method="post" style="margin-top:30px;" class="form-horizontal" enctype="multipart/form-data"   id="uploadForm">
 
    <div class="form-group">
  <label class="control-label col-sm-2"> Name:</label>
  <div class="col-sm-5">
    <input type="text" name="txtDname"  value="<?php echo isset($dname)?$dname:""?>"  placeholder="Driver Name" class="form-control" />
  ...
  <div class="col-sm-5">
      <input type="email" name="txtEmail"  placeholder="E-mail" value="<?php echo isset($mail)?$mail:""?>"   class="form-control" />
  ...
  <div class="col-sm-5">
      <input type="text" name="txtMobile"  placeholder="Mobile No"  value="<?php echo isset($mobile)?$mobile:""?>"   class="form-control" />
