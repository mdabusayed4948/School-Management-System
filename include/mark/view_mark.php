...
$mark_id = $_POST['txtMarkId'];	
 ...
 echo "<thead><tr><td colspan='10' style='background-color:#F5F5F5'>&nbsp;<span class=' boxshadow ' style='float:right;'><a href='home.php?item=61'  style='font-weight:bold; color:#5A5A5A; text-decoration:none; margin:3px'> <i class='glyphicon glyphicon-plus-sign'></i> Add Exam Number</a></span></td></tr>";

  echo "<tr><th>Number Id</th><th>Student Name</th><th>Class Roll </th><th>Subject </th><th>Exam Name </th><th>Session  </th><th>Class  </th><th>Section  </th><th>Obtained Mark  </th><th  width='150'>Options</th></thead></tr>";
 ...
 <tbody>
	...
	<div class="btn-group">
       ...
       <button type="button" class="label label-default btn-sm dropdown-toggle" data-toggle="dropdown">
        ...
        <li> 
          <form action='home.php?item=63' method='post'>
                <input type='hidden' value='<?php echo $mark_id;?>' name='txtMarkId'/>&nbsp;&nbsp;
                 ...
                 <div style="margin-left: 45px; margin-top: 3px">
  <li> 
        <form action='home.php?item=62' method='post' onSubmit="return confirm('Are you sure Delete this record?');" >
                <input type='hidden' value='<?php echo $mark_id?>' name='txtMarkId'/>&nbsp;&nbsp;
                    <span class="boxshadow"> 
