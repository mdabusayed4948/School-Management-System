...
?>
...
</span><span class='boxshadow'>  <button type="button" id='btnSearch'  class="btn btn-default"><img src="images/search-icon.png" width="20"/></button > </span> 
             ...
             <span style='float:left; margin-left:20px'><form action='#' method='post'>
<span class=' boxshadow'><input type='text'  id='txtSearc' placeholder='Class Name or Roll'> </span>

<span class='boxshadow'>  <button type="button" id='btnSearc'   class="btn btn-default"><img src="images/search-icon.png" width="20"/></button > </span> 
            ...
            <span style='float:left; margin-left:20px'> 
                <form action="home.php?item=8" method="POST">
                 <span class=' boxshadow' style="margin-left: 15px">
               <select class="selectpicker" data-show-subtext="true" data-live-search="true"  name="txtstatus"  data-size="10">
