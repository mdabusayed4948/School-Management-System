...
?>
 ...
 <thead><tr><td colspan='5' style='background-color:#F5F5F5'>&nbsp;<span class=' boxshadow ' style='float:right; padding: 4px'><a href=''  style='font-weight:bold; color:#5A5A5A; text-decoration:none'><i class='glyphicon glyphicon-plus-sign'></i></a></span></td></tr>

 <tr><th>Dormitory ID</th><th>Dormitory Name</th><th>Number of Room</th><th>Dormitory Description</th></tr></thead>
 <?php
